...
public class Techtalk extends Event{
	int fee_per_hour;	
	boolean flag=true;
	Common common=new Common();
	public Techtalk(String name,String Resource_person,String Designation,int event_slot[],String[] photos, int fee_per_hour,Common common){
	...
	synchronized private void photos() {
		...
		write(a,"\nphotos ela petalo teliyad,nerpiyale\n");
	...
	synchronized private void notes() {
		...
		write(a,"\t\t\t VASAVI COLLEGE OF ENGINEEERING\nSome Techtalk");
		flag=false;
		notify();
	}
