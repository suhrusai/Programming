...
static int i=0;
printf("\nenter name:\t");
scanf("%s",p[i].name); //Don’t give spaces in between your name.
printf("\nenter age:\t"); //Don’t Enter the same person details
again.
scanf("%d",&p[i].age);
printf("\nenter phone number:\t");
...
p[i].account_no=i+1;
p[i].bb=500; //Minimum Account Balance
...
carefully:");
printf("\nenter name:\t");
scanf("%s",p[i].name); //Don’t give spaces
...
if(p[i].bb < amt2)
{
printf("Bank balance is insufficient to
withdraw:\n");
printf("------------------------------------
-----------------------------------------------------------------\n");
printf("\t\tTHANK YOU\t\t\n");
...
{
printf("The current account balance
is:\t%lld\n",p[i].bb);
printf("------------------------------------------
-----------------------------------------------------------\n");
printf("\t\tTHANK YOU\t\t\n");
